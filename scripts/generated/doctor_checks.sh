...
declare -a MANIFEST_CHECKS=(
    ...
    "stack.automated_plan_reviser.1	APR - AI-powered plan revision and refinement (apr)	apr --help	required"
    "stack.automated_plan_reviser.2	APR - AI-powered plan revision and refinement (apr)	apr --version	optional"
    "stack.jeffreysprompts.1	JeffreysPrompts.com CLI - curated prompts for agentic coding (jfp)	jfp --help	required"
    "stack.jeffreysprompts.2	JeffreysPrompts.com CLI - curated prompts for agentic coding (jfp)	jfp status	optional"
    "stack.process_triage.1	Process Triage - intelligent process management (pt)	pt --help	required"
    "stack.process_triage.2	Process Triage - intelligent process management (pt)	pt --version	optional"
