      ...
      >
        ...
        <div
          style={{
            ...
            height: 500,
            borderRadius: "50%",
            background: getOrbGradient(colors.primary, 0.2),
            display: "flex",
          }}
        />
        <div
          style={{
            ...
            height: 550,
            borderRadius: "50%",
            background: getOrbGradient(colors.secondary, 0.15),
            display: "flex",
          }}
        />
        ...
        >
          ...
          <p
            style={{
              ...
              color: "#94a3b8",
              margin: 0,
              marginBottom: quickCommand ? 24 : 0,
              lineHeight: 1.5,
              display: "flex",
              maxWidth: 500,
            }}
          ...
          {quickCommand && (
            ...
            >
              <span style={{ fontSize: 14, color: "#64748b", display: "flex" }}>$</span>
              <span
                style={{
                  fontSize: 16,
                  color: colors.primary,
        ...
        >
          ...
          <div
            style={{
              ...
              height: 300,
              borderRadius: "50%",
              background: getOrbGradient(colors.primary, 0.35),
              filter: "blur(50px)",
              display: "flex",
            }}
          />
