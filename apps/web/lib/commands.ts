...
export const COMMANDS: CommandRef[] = [
  ...
  },
  {
    ...
    description: "AI-powered plan refinement and revision.",
    category: "stack",
    example: "apr refine plan.md -o refined.md",
    aliases: ["automated-plan-reviser"],
  },
  {
    name: "jfp",
    fullName: "JeffreysPrompts CLI",
    description: "Browse, copy, and install curated prompts for agents.",
    category: "stack",
  ...
  },
  {
    ...
    description: "Intelligent process management and diagnostics.",
    category: "stack",
    example: "pt --top",
  ...
  },
  {
    ...
    description: "Ultra-fast X/Twitter archive search with Tantivy.",
    category: "stack",
